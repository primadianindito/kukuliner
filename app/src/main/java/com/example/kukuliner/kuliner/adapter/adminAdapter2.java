...
public class adminAdapter2 extends RecyclerView.Adapter<adminAdapter2.myHolder> {
    private Context context;
    List<adminTab2> data;

    public adminAdapter2(Context context, List<adminTab2>data) {
    ...
    public myHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(context).inflate(R.layout.admin_adapter_tab2,parent,false);
    ...
    public class myHolder extends RecyclerView.ViewHolder{
        ...
        public myHolder(View itemView) {
            ...
            gambar = itemView.findViewById(R.id.admin_tab2_gambar);
            nama = itemView.findViewById(R.id.admin_tab2_name);
            email = itemView.findViewById(R.id.admin_tab2_email);
            noHP = itemView.findViewById(R.id.admin_tab2_noHP);
            alamat = itemView.findViewById(R.id.admin_tab2_alamat);
            banned = itemView.findViewById(R.id.admin_tab2_button);
                            ...
                            for(DataSnapshot ds:dataSnapshot.getChildren()){
                                ...
                                if(email.equals(data.get(getAdapterPosition()).getEmail())){
                                    if(getAdapterPosition()==-1){
                                        ...
                                        mDatabase.child(key).child("aktivasi").setValue("yes");
                                        Log.d("test", key);
                                    }
                                }
