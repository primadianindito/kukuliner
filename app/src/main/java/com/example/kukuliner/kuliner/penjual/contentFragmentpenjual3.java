...
public class contentFragmentpenjual3 extends Fragment {

    //Deklarasi datanya
    private RecyclerView recyclerView;
    LinearLayoutManager layoutManager;
    private List<penjualTab3> data;
    private DatabaseReference mDatabase;
    private StorageReference mStorageRef;
    penjualAdapter3 adapter1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.penjual_content_3, container,    false);

        //inisiasi data-datanya
        recyclerView  = rootView.findViewById(R.id.recycleview_content_penjual3);
        layoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(layoutManager);
        adapter1 = new penjualAdapter3(getContext(),data);
        ...
        mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot ds:dataSnapshot.getChildren()){
                    ...
                    if(username.equals(namaToko) && progress.equals("completed")){
                        data.add(new penjualTab3(pembeli,img,namaMakanan,porsi+" porsi/ Rp. "+(intharga*intporsi),progress,alamat));
                    }
